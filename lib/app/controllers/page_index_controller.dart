...
class PageIndexController extends GetxController {
      ...
      case 1:
        ...
        if (dataResponse["error"] != true) {
          ...
          double distance = Geolocator.distanceBetween(
              ...
              position.latitude,
              position
                  .longitude); // bisa di ganti latitude dan long ditudenya karena di stmik amikbandung
  ...
  Future<void> presensi(
    ...
    if (distance <= 250) {
      // ini bisa diubah mau berapa jarak untuk absennya menggunakan meter
      // di dalam area
    ...
    if (snapPresence.docs.length == 0) {
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                Get.back();
                Get.snackbar(
                    "Berhasil", "Kamu telah mengisi daftar ( MASUK ).");
              },
              child: Text("YES"),
            ),
          ]);
      ...
      if (todayDoc.exists == true) {
        ...
        Map<String, dynamic>? dataPreseToday = todayDoc.data();
        if (dataPreseToday?["keluar"] != null) {
          // sudah abasen masuk dan keluar
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    Get.back();
                    Get.snackbar(
                        "Berhasil", "Kamu telah mengisi daftar ( KELUAR ).");
                  },
                  child: Text("YES"),
                ),
              ]);
  ...
  Future<Map<String, dynamic>> determinePosition() async {
    ...
    if (permission == LocationPermission.deniedForever) {
      ...
      return {
        "message":
            "Settingan hp kamu tidak memperbolehkan untuk mengakses GPS, Ubah pada settinggan hp kamu.",
        "error": false,
      };
      // return Future.error(
